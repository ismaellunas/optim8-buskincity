@inject('profile', 'App\Services\UserProfileService')
...
<x-layouts.master>
    ...
    >
        ...
        <div class="section-heading has-text-centered">
          ...
          <div class="container">
            <p>
              Web developer with more than <strong>4 years</strong> of well-rounded experience with a degree in the
              field of
            ...
            <div class="card">
              <div class="card-content skills-content">
                ...
                <div class="content">
                    ...
                    @foreach($profile->getMeta('skills') as $skill)
                      <article class="media">

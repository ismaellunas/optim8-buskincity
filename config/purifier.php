...
return [
    ...
    'settings'      => [
        ...
        'tinymce' => [
            'HTML.Doctype'             => 'HTML 4.01 Transitional',
            'HTML.Allowed'             => 'a[href|title|target|id],b,blockquote,br,code[class],em,h1,h2,h3,h4,h5,h6,hr,i,img[width|height|alt|src],li,ol[start],p[style],pre,s,span[style],strong,sub,sup,table[class],tbody,td[class],th,thead,tr,u,ul,iframe[src|width|height|allowfullscreen]',
            'CSS.AllowedProperties'    => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align',
